...
const likeBlog = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        yield like_1.default.create({ blogId, userId });
        blog.likesCount++;
        yield blog.save();
        winston_1.logger.info('Blog liked successfully', {
            userId,
            blogId: blog._id,
        ...
        winston_1.logger.error('Error while liking the blog', error);
    }
});
exports.default = likeBlog;
